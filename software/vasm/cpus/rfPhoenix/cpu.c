...
//	"bbs",	{OP_LK,OP_REG,OP_IMM,OP_IMM,0}, {BL,CPU_ALL,0,0x00001F000822LL,6},
	...
	"cmp", {OP_REG,OP_REG,OP_VREG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TB(1LL)|OP(15LL),6},	
	"cmp", {OP_REG,OP_VREG,OP_REG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TA(1LL)|OP(15LL),6},	
	"cmp", {OP_REG,OP_VREG,OP_VREG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TB(1LL)|TA(1LL)|OP(15LL),6},	
	"cmp", {OP_VREG,OP_REG,OP_REG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TT(1LL)|OP(15LL),6},	
	"cmp", {OP_VREG,OP_REG,OP_VREG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TB(1LL)|TT(1LL)|OP(15LL),6},	
	"cmp", {OP_VREG,OP_VREG,OP_REG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TA(1LL)|TT(1LL)|OP(15LL),6},	
	"cmp", {OP_VREG,OP_VREG,OP_VREG,0,0},	{R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|TB(1LL)|TA(1LL)|TT(1LL)|OP(15LL),6},	
	"cmp", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,SZ(2LL)|FN(14LL)|OP(15LL),6},	
	
	"cmp", {OP_REG,OP_VREG,OP_IMM,0,0}, {RI,CPU_ALL,0,SZ(2LL)|TA(1LL)|OP(14LL),6},	
	"cmp", {OP_VREG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,SZ(2LL)|TT(1LL)|OP(14LL),6},	
	"cmp", {OP_VREG,OP_VREG,OP_IMM,0,0}, {RI,CPU_ALL,0,SZ(2LL)|TA(1LL)|TT(1LL)|OP(14LL),6},	
	"cmp", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,SZ(2LL)|OP(14LL),6},	
